# Oracle Order Orchestration API

Jade Global — **erp-integration** domain (EI)

## OpenAPI Spec

The canonical spec lives at [`openapi/oracle-order-orchestration-api.yaml`](openapi/oracle-order-orchestration-api.yaml).
...
```bash
docker build -t jade-oracle-order-orchestration-api:latest k8s/mock-service/
```
